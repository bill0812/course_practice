...
if __name__ == "__main__":
    ...
    image_rgb_mine = cv2.imread("download-2.png",1)
    image_rgb_cv = image_rgb_mine
    image_gray = cv2.imread("download-2.png",0)
    ...
    cv2.imshow('compare two ways (download-2)',combine_all)
    cv2.imwrite('combine_all_download-2.png',combine_all)
